...
export class User {
   ...
   public static async authenticateByNameAndPassword(
...
export let UserModel: ReturnModelType<typeof User>;

if (mongoose.models.User) {
  UserModel = mongoose.models.User as ReturnModelType<typeof User>;
} else {
