...
export default function LoginForm() {
   ...
   return <div className="h-screen flex flex-col items-center justify-center">
      ...
      <div className="w-[100%] justify-center flex mt-9">
         <form className="w-[70%] h-[70%] p-3 max-w-150" method="post" action={submitAction}>
            <p>
            ...
            <div className="flex items-center justify-end">
               {response && !response.success && (<span className="text-red-500 text-xl font-medium text-center">Login Fail</span>)}
               ...
               font-bold hover:bg-transparent hover:cursor-pointer rounded-2xl w-22 h-12">
                  {isPending ? (<div role="status" className="leading-5">
